...
export const AdminDashboard: React.FC = () => {
  ...
  const loadData = () => {
    ...
    const d = db.getDonors() as Donor[];

    const r = db.getRequests() as EmergencyRequest[];
    ...
    setAvailableCount(d.filter((donor: Donor) => donor.available).length);
  ...
  const tableFilteredDonors = donorsList.filter((donor: Donor) => {
